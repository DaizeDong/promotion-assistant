...
recreate the config repo's scripts/apply.py — that is forked from market-intel-config (the
...
def main():
    ...
    print("  3) Fork scripts/apply.py from market-intel-config (see scripts/apply.README.md).")
